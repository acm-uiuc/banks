...
export const collections = {
  articles: defineCollection({
    ...
    schema: ({ image }) => z.object({
      ...
      byline: z.optional(z.coerce.string()).describe("Custom byline for the article; this field OVERRIDES the byline generated by the authors field"),
      ...
      slug: z.optional(z.coerce.string().regex(/^[a-z0-9]+(?:-[a-z0-9]+)*$/)).describe("Custom URL slug for the article (lowercase letters, numbers, hyphens only)"),
    }),
  }),
  ...
  profiles: defineCollection({
    ...
    schema: ({image}) => z.object({
      name: z.coerce.string().describe("Full name"),
      profile_image: z.optional(ImageObject(image)).describe("Profile picture or avatar"),
    }),
  }),
};
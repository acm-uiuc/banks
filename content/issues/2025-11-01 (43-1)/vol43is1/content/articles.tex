...
Though there were many hardware challenges along the way, including one of the arms and one of the cameras completely breaking, the team adapted and overcame these, fine-tuning and running their final model for the first time 20 minutes before the demo to the judges (the second time they ran it was during the demo!). Read more about this project here: \href{https://www.hackster.io/sigrobotics/embodied-ai-hackathon-submission-sigrobotics-1st-place-f0e520}{here}
...
\byline{\textbf{\Large Why NLP Matters More than Ever}}{Vinay Rajagopalan}

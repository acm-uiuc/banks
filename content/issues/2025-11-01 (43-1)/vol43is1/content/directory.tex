...
\noindent\textbf{Website:} acm.illinois.edu\\
\noindent\textbf{Discord:} acm.gg/discord\\
\noindent\textbf{Instagram:} instagram.com/acm.uiuc\\
...
\noindent\textbf{Website:} infra.acm.illinois.edu\\
...
\noindent\textbf{Website:} academic.acm.illinois.edu\\
...
\begin{minipage}{\columnwidth}
\begin{center}
\includegraphics[width=0.35\columnwidth]{./logo/reflections_projections.png}
\end{center}
\vspace{0.05cm}
\subsection*{Reflections \textbar{} Projections}
\noindent\textbf{Chairs:} Cole Jordan, Shreenija Daggavolu\\
\noindent\textbf{Website:} reflectionsprojections.org/\\
...
\noindent\textbf{Website:} hackillinois.org\\
...
\noindent\textbf{Website:} sigpwny.com\\
\noindent\textbf{Discord:} discord.gg/cWcZ6a9\\

{\setlength{\parindent}{1.5em}
Learn how to hack! SIGPwny is the Special Interest Group for Information Security.
Our General meetings focus on the fundamentals of security, including topics on binary exploitation, web hacking, and cryptography.
We also play in hacking competitions, known as Capture the Flag (CTF).
Our Embedded Team focuses on hardware hacking and embedded systems security.
The Purple Team focuses on both offensive and defensive security techniques.
Join our Discord at https://sigpwny.com/discord!
}
\end{minipage}
...
\noindent\textbf{Website:} sigchi.acm.illinois.edu/\\
\noindent\textbf{Discord:} discord.gg/XRShsPCAQ3\\
...
\noindent\textbf{Website:} gamebuilders.acm.illinois.edu/\\
\noindent\textbf{Discord:} discord.com/invite/2rND6FT\\
...
\noindent\textbf{Website:} aida.acm.illinois.edu\\
\noindent\textbf{Discord:} acm.gg/aida\_discord\\
...
\noindent\textbf{Website:} siggraph.acm.illinois.edu/\\
\noindent\textbf{Discord:} discord.com/invite/a5U333fNMX\\
...
\noindent\textbf{Website:} icpc.cs.illinois.edu/\\
\noindent\textbf{Discord:} acm.gg/icpc\_discord\\
...
\noindent\textbf{Website:} sigmusic.acm.illinois.edu/\\
\noindent\textbf{Discord:} acm.gg/sigmusic\_discord\\
...
\noindent\textbf{Website:} lug.acm.illinois.edu/\\
\noindent\textbf{Discord:} discord.gg/sWD3zxPyc2\\
\noindent\textbf{Matrix:} matrix.to/\#/\#gnulug:matrix.org\\
...
\noindent\textbf{Discord:} discord.gg/wwYeewYkCG\\
...
\noindent\textbf{Website:} cstheory.org/\\
\noindent\textbf{Discord:} discord.gg/Sxf3h3pBbv\\
...
\noindent\textbf{Website:} sigquantum.com\\
\noindent\textbf{Discord:} discord.gg/PmaXeHPaFs\\
...
\noindent\textbf{Discord:} acm.gg/ecom\_discord\\
...
\noindent\textbf{Discord:} acm.gg/sigplan\_discord\\
...
\noindent\textbf{Meetings:} Tuesdays, 7:00 PM--8:00 PM, Biweeekly, Siebel CS 3401\\
\noindent\textbf{Website:} sigpolicy.acm.illinois.edu/\\
\noindent\textbf{Discord:} discord.gg/gKjMH54YBF\\
...
\noindent\textbf{Website:} sigarch.net/\\
\noindent\textbf{Discord:} discord.gg/Mx8R389hWz\\
...
\noindent\textbf{Website:} sigrobotics.acm.illinois.edu/\\
\noindent\textbf{Discord:} discord.gg/Rj75e5qGT3\\
...
\noindent\textbf{Website:} sigtricity.acm.illinois.edu/\\
\noindent\textbf{Discord:} discord.gg/4yRWQuzhEV\\
